namespace Enhanced.Doxygen
{
    ...
    internal static class Commands
    {
        ...
        /// </summary>
        [Pattern(@"^*(?<" + FormatNames.DoxygenCommand + 
                 @">[@\\]class)\s+(?<" + FormatNames.DoxygenClassName + 
                 @">\w+\b)?\s+(?<" + FormatNames.DoxygenHeaderFile + 
                 @">[\w.-]+\b)?\s+(?<" + FormatNames.DoxygenHeaderName +
                 ">\"" + @"?[\w/\\.-]+\b" + "\"?)?")]
        ...
        /// </summary>
        [Pattern(@"^*(?<" + FormatNames.DoxygenCommand + 
                 @">[@\\]def)\s+(?<" + FormatNames.DoxygenMacroName + 
                 @">.+)?")]
        ...
        /// </summary>
        [Pattern(@"^*(?<" + FormatNames.DoxygenCommand +
                 @">[@\\]defgroup)\s+(?<" + FormatNames.DoxygenGroupName +
                 @">\w+\b)?\s+(?<" + FormatNames.DoxygenGroupTitle +
                 @">\w+\b)?")]
        ...
        /// </summary>
        [Pattern(@"^*(?<" + FormatNames.DoxygenCommand +
                 @">[@\\]dir)\s+(?<" + FormatNames.DoxygenDirPath +
                 @">.+)?")]
        ...
        /// </summary>
        [Pattern(@"^*(?<" + FormatNames.DoxygenCommand +
                 @">[@\\]enum)\s+(?<" + FormatNames.DoxygenClassName +
                 @">.+)?")]
        ...
        /// </summary>
        [Pattern(@"^*(?<" + FormatNames.DoxygenCommand +
                 @">[@\\]example)\s+(?<" + FormatNames.DoxygenDirPath +
                 @">.+)?")]
